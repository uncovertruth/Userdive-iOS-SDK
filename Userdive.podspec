#
#  Be sure to run `pod spec lint Userdive.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mitsukuni Sato"
  # s.authors            = { "Mitsukuni Sato" => "mitsukuni.sato@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Mitsukuni Sato"
  ...
  s.source       = { :git => "http://EXAMPLE/Userdive.git", :tag => "0.0.1" }
